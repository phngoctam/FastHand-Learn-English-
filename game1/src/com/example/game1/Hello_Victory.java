...
public class Hello_Victory extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hello__victory);
		...
		Thread bamgio = new Thread()
		{
			...
			public void run(){
				try {
					...
					myIntent = new Intent(Hello_Victory.this, Score.class);
					bundle = new Bundle();
					giftIdtopic = idtopic;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.hello__victory, menu);
		return true;
	}
