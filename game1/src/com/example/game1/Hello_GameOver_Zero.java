...
public class Hello_GameOver_Zero extends Activity {
	Intent myIntent;
	Bundle bundle;
	Intent callerIntent;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hello__game_over__zero);
		...
		Thread bamgio = new Thread()
		{
			...
			public void run(){
				try {
					...
					myIntent = new Intent(Hello_GameOver_Zero.this, ZeroScore.class);
					bundle = new Bundle();
					giftIdtopic = idtopic;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.hello__game_over__zero, menu);
		return true;
	}
