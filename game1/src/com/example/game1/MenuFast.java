...
public class MenuFast extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_menu_fast);
	...
	public void solvetopic1() {
		myIntent = new Intent(MenuFast.this, Fast.class);
		bundle = new Bundle();
	...
	public void onBackPressed() {
		// TODO Auto-generated method stub
		super.onBackPressed();
		Intent myintent = new Intent(MenuFast.this, MainActivity.class);
		startActivity(myintent);
	}
